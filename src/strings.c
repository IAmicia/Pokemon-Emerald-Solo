...
const u8 gText_ThatItemIsSoldOut[] = _("Je suis désolé, cet objet est en rupture de stock.{PAUSE_UNTIL_PRESS}");
const u8 gText_SoldOut[] = _("RUPTURE DE STOCK");
...
const u8 gText_ThrowInPremierBalls[] = _("Je mets {STR_VAR_1} HONOR BALL en plus.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NextFusionMon[] = _("Choissisez {PKMN} pour fusionner avec.");
...
const u8 gText_PkmnFrostbiteHealed[] = _("{STR_VAR_1}'s engelures ont été guéries.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnGainedExp[] = _("{STR_VAR_1} gagne {STR_VAR_2} points d'Exp. !{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGainedExpAndElevatedToLvVar3[] = _("{STR_VAR_1} gagne {STR_VAR_2} points d'Exp.\net monte au N. {STR_VAR_3} !");
...
const u8 gText_PkmnTransformed[] = _("{STR_VAR_1} ce transforme !{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WhichAppliance[] = _("Quel appliance\ncommander?");
...
const u8 gText_LightBulb[] = _("Ampoule électrique");
const u8 gText_MicrowaveOven[] = _("Four à micro-ondes");
const u8 gText_WashingMachine[] = _("Machine à laver");
const u8 gText_Refrigerator[] = _("Réfrigérateur");
const u8 gText_ElectricFan[] = _("Ventilateur électrique");
const u8 gText_LawnMower[] = _("Tondeuse à gazon");
const u8 gText_ChangeForm[] = _("Change de forme");
const u8 gText_ChangeAbility[] = _("Change de  Capacité");
...
const u8 gText_ExpShareOn[] = _("Le multi-exp a est activé.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Le multi-exp a été désactivé.{PAUSE_UNTIL_PRESS}");
const u8 gText_BasePointsResetToZero[] = _("Les statistiques de base de {STR_VAR_1}\non été réinitialisé à zéro!{PAUSE_UNTIL_PRESS}");
const u8 gText_Fertilize[] = _("ENGRAIS");
